...
function procesaNodo(listaAbiertos, nodoPadre, i, j, iFin, jFin, matPadres){
...
function procesa(NodoPadre, i, j, iFin, jFin, matCerrados, listaAbiertos, numFils, numCols, matPadres, callback){
  ...
  if(esFactible(i-1, j, matCerrados, numFils, numCols))
      procesaNodo(listaAbiertos, NodoPadre, i-1, j, iFin,jFin, matPadres)

  if(esFactible(i-1, j+1, matCerrados, numFils, numCols))
    procesaNodo(listaAbiertos, NodoPadre, i-1, j+1, iFin,jFin, matPadres)

  if(esFactible(i, j+1, matCerrados, numFils, numCols))
    procesaNodo(listaAbiertos, NodoPadre, i, j+1, iFin,jFin, matPadres)
